...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("kaccelero-database-sentry", "dev.kaccelero", "database-exposed-sentry").versionRef("kaccelero")
            ...
            library("s3", "software.amazon.awssdk:s3:2.31.4")
        }
    }
}
